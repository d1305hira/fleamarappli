  ...
  <header class="bg-dark text-white py-2">
    <div class="container">
      <div class="row align-items-center">
        <!-- 左側：ロゴ -->
        <div class="col-md-2">
          <a href="{{ route('top') }}" class="text-white fw-bold text-decoration-none">COACHTECH</a>
        </div>
        ...
        <div class="col-md-6">
          <form action="{{ route('top') }}" method="GET">
            <input type="text" name="keyword" class="form-control" placeholder="何をお探しですか？" value="{{ request('keyword') }}">
          </form>
        </div>
